...
(function() {
  ...
  Layer = L.Class.extend({
    defaultI18n: {
      ...
      ru: {
        currentTemperature: "Ð¢ÐµÐ¼Ð¿ÐµÑ€Ð°Ñ‚ÑƒÑ€Ð°",
        maximumTemperature: "ÐœÐ°ÐºÑ. Ñ‚ÐµÐ¼Ð¿",
        minimumTemperature: "ÐœÐ¸Ð½. Ñ‚ÐµÐ¼Ð¿",
        humidity: "Ð’Ð»Ð°Ð¶Ð½Ð¾ÑÑ‚ÑŒ",
        wind: "Ð’ÐµÑ‚ÐµÑ€",
        show: "Ð¡Ð½ÐµÐ³",
        snow_possible: "Ð’Ð¾Ð·Ð¼Ð¾Ð¶ÐµÐ½ ÑÐ½ÐµÐ³",
        rain: "Ð”Ð¾Ð¶Ð´ÑŒ",
        rain_possible: "Ð’Ð¾Ð·Ð¼Ð¾Ð¶ÐµÐ½ Ð´Ð¾Ð¶Ð´ÑŒ",
        icerain: "Ð›ÐµÐ´ÑÐ½Ð¾Ð¹ Ð´Ð¾Ð¶Ð´ÑŒ",
        rime: "Ð“Ð¾Ð»Ð¾Ð»ÐµÐ´",
        rime_possible: "Ð’Ð¾Ð·Ð¼Ð¾Ð¶ÐµÐ½ Ð³Ð¾Ð»Ð¾Ð»ÐµÐ´",
        clear: "Ð¯ÑÐ½Ð¾"
      }
    },
    ...
    buildMarker: function(st, ll) {
      ...
      popupContent += "<p>";
      popupContent += "" + this.i18n.currentTemperature + ":&nbsp;" + (this.toCelc(st.temp)) + "&nbsp;Â°C<br />";
      if (st.temp_max) {
        popupContent += "" + this.i18n.maximumTemperature + ":&nbsp;" + (this.toCelc(st.temp_max)) + "&nbsp;Â°C<br />";
      }
      if (st.temp_min) {
        popupContent += "" + this.i18n.minimumTemperature + ":&nbsp;" + (this.toCelc(st.temp_min)) + "&nbsp;Â°C<br />";
      }
  ...
  Layer.Utils = {
    ...
    checkSunCal: function() {
      ...
      el.src = 'https://cdnjs.cloudflare.com/ajax/libs/suncalc/1.8.0/suncalc.min.js';
