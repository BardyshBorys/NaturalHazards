...
L.OWM.Current = L.Layer.extend({
	...
	options: {
		...
		imageLoadingUrl: 'static/img/owmloading.gif', // URL of loading image relative to HTML document
	...
	initialize: function(options) {
		...
		this._map = null;
		this._urlTemplate = 'https://api.openweathermap.org/data/2.5/box/{type}?{appId}cnt=300&format=t.json&units=metric&bbox={minlon},{minlat},{maxlon},{maxlat},10';
